...
const Register = () => {
    ...
    return (
        <div className="min-h-screen mt-16 flex items-center justify-center bg-gray-50 dark:bg-[#121212] transition-colors duration-500 px-4">
            <Toaster />
            <div className="max-w-md w-full bg-white dark:bg-[#1c1c1e] rounded-2xl shadow-lg p-8">
                ...
                <motion.div
                    ...
                    initial="hidden"
                    whileInView={'show'} className="flex items-center my-6">
